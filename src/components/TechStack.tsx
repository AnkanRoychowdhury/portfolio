...
import { FaJs, FaNodeJs, FaJava, FaGitAlt, FaAws } from 'react-icons/fa';
...
export const TechStack = () => {
  const technologies = [
    ...
    { name: 'AWS', icon: <FaAws className="text-5xl text-white-600" />, delay: 4 },
    { name: 'ZIPKIN', icon: <img src={zipkin} className="text-5xl text-white-600" />, delay: 4 },
    { name: 'Postgresql', icon: <SiPostgresql className="text-5xl text-sky-700" />, delay: 3 },
    { name: 'Hibernate', icon: <img src={hibernate} className="text-5xl" />, delay: 4 },
    ...
    { name: 'MongoDB', icon: <img src={mongo} className="text-5xl text-yellow-500" width={100} />, delay: 4 },
